const Footer = () => {
  ...
  <aside>
    ...
    <p className="font-bold">
      Book Industries Ltd. <br/>Providing reliable tech since 2001
    </p> 
    <p className="font-bold">
      Phon Number:01918992228
    </p> 
    <p className="font-bold">
      Emailaddress: Skemon152@gmail.com
    </p> 
    <p className="text-2xl font-bold">type your exprience</p>
    <textarea className="border border-black" name="" id="" cols="30" rows="10" placeholder="type your exprience"> </textarea>
